...
// --- Main Component ---
const EarningsStatChart: React.FC<EarningsStatChartProps> = ({
  totalEarnings = 80000,
  data = earningsData,
  onViewAll,
}) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 w-full font-sans">
      ...
      <div className="flex items-start justify-between mb-1">
        ...
        <button
          onClick={onViewAll}
          className="flex items-center gap-1 text-sm text-gray-700 font-medium border border-gray-200 rounded-full px-4 py-1.5 hover:bg-gray-50"
        >
          View all earnings
      ...
      <div className="mt-4 mb-2">
        <div className="inline-flex flex-col">
          ...
          <span className="mt-1 text-[11px] text-pink-600 bg-pink-50 border border-pink-200 rounded-full px-2 py-0.5 w-fit">
            total earnings
          </span>
        </div>
      </div>
...
export default EarningsStatChart;