            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 p-4">
              ...
              <div className="p-2 flex flex-col justify-center gap-2 shadow-lg rounded-2xl">
                <div className="h-30 w-full relative rounded-3xl overflow-hidden">
                  <div className="absolute w-[50%] text-[10px] font-light h-8 bottom-0 left-0 bg-linear-to-r from-[#FF5BC8] to-[#A403CC] flex items-center justify-center text-white rounded-tr-3xl rounded-bl-3xl">
                    Ends in 2 days
                  </div>
                ...
                <div className="bg-[#FBC02D33] mt-3 rounded-3xl px-3 py-1 w-fit">
                  ...
                  <span className="text-[11px] text-white bg-[#3E3E3E] p-1 rounded-3xl">
                    10min
                  </span>
                </div>
                <h2 className="text-sm font-semibold">
                  Market Research on Mobile Banking
                </h2>
                <p className="text-[10px]">
                  The continuous surge in technological innovation and
                  breakthrough advancements refining how we...
                </p>
                <div className="flex gap-2">
                  <div className="bg-[#FBC02D33] mt-3 rounded-3xl px-3 py-1 w-fit flex justify-center items-center">
                    <div className="text-[10px] flex gap-1">
                      <img src="/images/dashboard/users.svg" />
                      <span>20 Participant</span>{" "}
                    </div>
                  </div>
                  <div className="bg-[#FBC02D33] mt-3 rounded-3xl px-3 py-1 w-fit flex justify-center items-center">
                    <div className="text-[10px] flex gap-1">
                      <img src="/images/dashboard/survey-icon.svg" />
                      <span>Survey</span>{" "}
                    </div>
                  </div>
                </div>
